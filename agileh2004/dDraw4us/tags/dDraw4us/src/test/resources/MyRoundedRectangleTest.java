...
class MyRoundedRectangleTest {
	private MyRoundedRectangle rectangle;
	@BeforeAll
	...
	@BeforeEach
	public void buildUp() {
		rectangle= new MyRoundedRectangle();
	...
	void resizeOnPressedTest() {
		...
		rectangle.resizeOnPressed(1.1, 1.1);
		assertEquals(Color.RED, rectangle.getShape().getStroke());
		assertEquals(5, rectangle.getShape().getStrokeWidth());
	}
	...
	void dragOnPressedTest() {
		...
		rectangle.dragOnPressed(1.1, 1.1);
		assertEquals(Color.RED, rectangle.getShape().getStroke());
		assertEquals(5, rectangle.getShape().getStrokeWidth());
	}
