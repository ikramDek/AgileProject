...
public class MainUIController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		Platform.runLater(() -> {
			...
			try {
				...
				canevasController.setPaletteOutilsUIController(paletteOutilsController);
				...
				menuController.refreshCustomShapesList(canevasController.getCustomShapesList());
	...
	public void keyPressed(KeyEvent e) {
		if (canevasController.getSelectedShape() != null) {
			...
			canevasController.getStausBarController().setSelectedText(canevasController.getSelectedShape());
		}
