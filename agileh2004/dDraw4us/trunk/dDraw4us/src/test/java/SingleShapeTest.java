...
public class SingleShapeTest {
	...
	public void propertiesTest() {
		shape.setProperties(new Point2D(2d, 2d), new Point2D(0d, 0d), null, 1.0, null, 1.0, "layout");
		assertEquals("layout", shape.getLayout());
		shape.applyRotation();
		assertEquals(6.0, shape.getShape().getRotate());
	...
	public void isInsideTest() {
		...
		shape.setProperties(new Point2D(0d, 0d), new Point2D(0d, 0d), null, 1.0, null, 1.0, "layout");
	...
	public void onPressedTest() {
		...
		assertEquals(4, shape.getShape().getStrokeWidth());
	}
	...
	public void drawWithMagnetismTest() {
		...
		shape.setStartY(3.0);
		shape.setEndX(5.0);
		assertEquals(5.0, shape.getEndX());
		shape.setEndY(4.0);
		assertEquals(4.0, shape.getEndY());
