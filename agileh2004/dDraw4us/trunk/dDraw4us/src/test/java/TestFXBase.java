 ...
 public abstract class TestFXBase extends ApplicationTest{
	...
	public void start(Stage stage) {
		...
		try {
			...
			stage.setOnHidden(e -> {
				// we wont be saving the application state when closing for the tests
	...
	public Shape drawFirstShapeAndSelectIt() {
	...
	public Shape drawSecondShapeAndSelectIt() {
		clickOn("#roundedRectBtn");
		...
		Shape shapeToSelect = mainController.getCanevasController().getAllShapes().get(1).getSingleShapeList().get(0).getShape();
